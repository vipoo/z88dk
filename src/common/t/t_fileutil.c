...
void t_fileutil_path_canon(void)
{
    ...
    TEST_ASSERT_EQUAL_STRING("c:/abc/def",
                             path_canon("c://\\//abc//\\//def//\\//"));
...
void t_fileutil_path_find_all(void)
{
    ...
    argv_sort(f);
    char** p = argv_front(f);
    TEST_ASSERT_EQUAL_STRING("test_dir/test.f0", *p);
    p++;
    TEST_ASSERT_EQUAL_STRING("test_dir/x1", *p);
    p++;
    TEST_ASSERT_EQUAL_STRING("test_dir/x2", *p);
    p++;
    TEST_ASSERT_EQUAL_STRING("test_dir/x3", *p);
    p++;
    TEST_ASSERT_NULL(*p);
    argv_free(f);
    ...
    TEST_ASSERT_EQUAL_STRING("test_dir/x1", *p);
    p++;
    TEST_ASSERT_EQUAL_STRING("test_dir/x1/test.f0", *p);
    p++;
    TEST_ASSERT_EQUAL_STRING("test_dir/x1/test.f1", *p);
    p++;
    TEST_ASSERT_EQUAL_STRING("test_dir/x2", *p);
    p++;
    TEST_ASSERT_EQUAL_STRING("test_dir/x2/test.f1", *p);
    p++;
    TEST_ASSERT_EQUAL_STRING("test_dir/x2/test.f2", *p);
    p++;
    TEST_ASSERT_EQUAL_STRING("test_dir/x3", *p);
    p++;
    TEST_ASSERT_EQUAL_STRING("test_dir/x3/test.f2", *p);
    p++;
    TEST_ASSERT_EQUAL_STRING("test_dir/x3/test.f3", *p);
    p++;
    TEST_ASSERT_NULL(*p);
    argv_free(f);
...
void t_fileutil_path_find_glob(void)
{
    ...
    for (int d1 = 'a'; d1 <= 'b'; d1++) {
        for (int d2 = '1'; d2 <= '2'; d2++) {
            str_set_f(pad, "test_dir/%c/%c", d1, d2);
            path_mkdir(str_data(pad));
            str_set_f(pad, "test_dir/%c/%c/d", d1, d2);
            path_mkdir(str_data(pad));

            str_set_f(pad, "test_dir/%c/%c/f%d.c", d1, d2, ++file);
            file_spew(str_data(pad), "");
            str_set_f(pad, "test_dir/%c/%c/f%d.c", d1, d2, ++file);
            file_spew(str_data(pad), "");
            str_set_f(pad, "test_dir/%c/%c/f%d.c", d1, d2, ++file);
            file_spew(str_data(pad), "");
    ...
    argv_sort(f);
    char** p = argv_front(f);
    TEST_ASSERT_EQUAL_STRING("test_dir/a/1/f1.c", *p);
    p++;
    TEST_ASSERT_NULL(*p);
    argv_free(f);
    ...
    TEST_ASSERT_EQUAL_STRING("test_dir/a/1/f1.c", *p);
    p++;
    TEST_ASSERT_EQUAL_STRING("test_dir/a/1/f2.c", *p);
    p++;
    TEST_ASSERT_EQUAL_STRING("test_dir/a/1/f3.c", *p);
    p++;
    TEST_ASSERT_NULL(*p);
    argv_free(f);
    ...
    TEST_ASSERT_EQUAL_STRING("test_dir/a/1/f3.c", *p);
    p++;
    TEST_ASSERT_EQUAL_STRING("test_dir/a/2/f4.c", *p);
    p++;
    TEST_ASSERT_EQUAL_STRING("test_dir/a/2/f5.c", *p);
    p++;
    TEST_ASSERT_EQUAL_STRING("test_dir/a/2/f6.c", *p);
    p++;
    TEST_ASSERT_EQUAL_STRING("test_dir/b/1/f7.c", *p);
    p++;
    TEST_ASSERT_EQUAL_STRING("test_dir/b/1/f8.c", *p);
    p++;
    TEST_ASSERT_EQUAL_STRING("test_dir/b/1/f9.c", *p);
    p++;
    TEST_ASSERT_NULL(*p);
    argv_free(f);
    ...
    TEST_ASSERT_EQUAL_STRING("test_dir/b/1/f9.c", *p);
    p++;
    TEST_ASSERT_EQUAL_STRING("test_dir/b/2/f10.c", *p);
    p++;
    TEST_ASSERT_EQUAL_STRING("test_dir/b/2/f11.c", *p);
    p++;
    TEST_ASSERT_EQUAL_STRING("test_dir/b/2/f12.c", *p);
    p++;
    TEST_ASSERT_NULL(*p);
    argv_free(f);
