...
void t_strutil_cstr_toupper(void)
{
    char buff[10];
    strcpy(buff, "abc1");
    TEST_ASSERT_EQUAL_STRING("ABC1", cstr_toupper(buff));
    strcpy(buff, "Abc1");
    TEST_ASSERT_EQUAL_STRING("ABC1", cstr_toupper(buff));
    strcpy(buff, "ABC1");
    TEST_ASSERT_EQUAL_STRING("ABC1", cstr_toupper(buff));
...
void t_strutil_cstr_tolower(void)
{
    char buff[10];
    strcpy(buff, "abc1");
    TEST_ASSERT_EQUAL_STRING("abc1", cstr_tolower(buff));
    strcpy(buff, "Abc1");
    TEST_ASSERT_EQUAL_STRING("abc1", cstr_tolower(buff));
    strcpy(buff, "ABC1");
    TEST_ASSERT_EQUAL_STRING("abc1", cstr_tolower(buff));
...
void t_strutil_cstr_chomp(void)
{
    char buff[100];
    strcpy(buff, "");
    TEST_ASSERT_EQUAL_STRING("", cstr_chomp(buff));
    strcpy(buff, "\r\n \t\f \r\n \t\f\v");
    TEST_ASSERT_EQUAL_STRING("", cstr_chomp(buff));
    strcpy(buff, "\r\n \t\fx\r\n \t\f\v");
...
void t_strutil_cstr_strip(void)
{
    char buff[100];
    strcpy(buff, "");
    TEST_ASSERT_EQUAL_STRING("", cstr_strip(buff));
    strcpy(buff, "\r\n \t\f \r\n \t\f\v");
    TEST_ASSERT_EQUAL_STRING("", cstr_strip(buff));
    strcpy(buff, "\r\n \t\fx\r\n \t\f\v");
    TEST_ASSERT_EQUAL_STRING("x", cstr_strip(buff));
}
...
void t_strutil_str_getline(void)
{
    file_spew("test.txt", "aa\nbb\rcc\r\ndd");
    ...
    char* line;
    str_set(str, "xx");
    line = str_getline(str, fp);
    TEST_ASSERT_NOT_NULL(line);
    TEST_ASSERT_EQUAL_STRING("aa\n", line);
    TEST_ASSERT(line == str_data(str));
    ...
    line = str_getline(str, fp);
    TEST_ASSERT_NOT_NULL(line);
    TEST_ASSERT_EQUAL_STRING("cc\n", line);
    TEST_ASSERT(line == str_data(str));

    str_set(str, "xx");
    line = str_getline(str, fp);
    TEST_ASSERT_NOT_NULL(line);
    TEST_ASSERT_EQUAL_STRING("dd", line);
    TEST_ASSERT(line == str_data(str));

    str_set(str, "xx");
    line = str_getline(str, fp);
    TEST_ASSERT_NULL(line);
    TEST_ASSERT_EQUAL_STRING("", str_data(str));
...
void t_strutil_str_toupper(void)
{
    ...
    str_set(s, "abc1");
    str_toupper(s);
    TEST_ASSERT_EQUAL_STRING("ABC1", str_data(s));
    str_set(s, "Abc1");
    str_toupper(s);
    TEST_ASSERT_EQUAL_STRING("ABC1", str_data(s));
    str_set(s, "ABC1");
...
void t_strutil_str_strip(void)
{
    ...
    str_set(s, "\r\n \t\fx\r\n \t\f\v");
    str_strip(s);
    TEST_ASSERT_EQUAL_STRING("x", str_data(s));
    str_free(s);
}
...
void t_strutil_argv_new(void)
{
    ...
    TEST_ASSERT_EQUAL_STRING("0", *p);
    p++;
    TEST_ASSERT_EQUAL_STRING("0,5", *p);
    p++;
    TEST_ASSERT_EQUAL_STRING("1", *p);
    p++;
    TEST_ASSERT_EQUAL_STRING("2", *p);
    p++;
    TEST_ASSERT_EQUAL_STRING("2.5", *p);
    p++;
    TEST_ASSERT_EQUAL_STRING("3", *p);
    p++;
    TEST_ASSERT_EQUAL_STRING("3.5", *p);
    p++;
    TEST_ASSERT_NULL(*p);
...
void t_strutil_argv_sort(void)
{
    ...
    TEST_ASSERT_EQUAL_STRING("1", *p);
    p++;
    TEST_ASSERT_EQUAL_STRING("11", *p);
    p++;
    TEST_ASSERT_EQUAL_STRING("2", *p);
    p++;
    TEST_ASSERT_EQUAL_STRING("22", *p);
    p++;
    TEST_ASSERT_EQUAL_STRING("25", *p);
    p++;
    TEST_ASSERT_NULL(*p);
    argv_free(argv);
}
