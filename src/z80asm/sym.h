...
bool            is_defined :
1;     /* true if symbol was defined in the current module */
bool            is_touched :
1;     /* true if symbol was used, e.g. returned by
                                         * a symbol table search */
bool            is_global_def :
1;  /* true for __head, __tail, __size symbols */
struct Module*  module;             /* module which owns symbol (weak ref) */
struct Section*
    section;            /* section where expression is defined (weak ref) */
...
extern Symbol* Symbol_create(const char* name, long value, sym_type_t type,
                             sym_scope_t scope,
