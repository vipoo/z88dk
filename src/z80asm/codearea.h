...
void  patch_byte( int addr, byte_t byte1 );		/* one byte */
void append_byte( byte_t byte1 );
void append_2bytes( byte_t byte1, byte_t byte2 );

void  patch_word(int addr, int word);			/* 2-byte word */
void append_word(int word);

void  patch_word_be(int addr, int word);			/* 2-byte word big endian*/
void append_word_be(int word);

void  patch_long( int addr, long dword );		/* 4-byte long */
