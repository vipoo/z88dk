...
*----------------------------------------------------------------------------*/
typedef void (*new_line_cb_t)(const char* filename, int line_nr,
                              const char* text );
...
/* set call-back when reading a new line; return old call-back */
extern incl_recursion_err_cb_t set_incl_recursion_err_cb(
    incl_recursion_err_cb_t func );
...
extern bool SrcFile_open( SrcFile* self, const char* filename,
                          UT_array* dir_list );
...
extern const char* SrcFile_filename( SrcFile*
                                     self );       /* string in strpool */
